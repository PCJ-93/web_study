...
public class MyCookieUtil { //Cookie 들 간편하게 쓰려고 만든 클래스
	...
	public static String getCookie(HttpServletRequest request, String cookieName) {
		...
		return getCookie(cookies, cookieName); //위에있는 getCookie 메소드 재사용
	}
	...
	public static Cookie createCookie(String name, String value, int ageSecond) {
		...
		//Cookie ck = createCooke(name, value); 과하게 한 리팩토링ㅋ
